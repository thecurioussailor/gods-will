...
const Hero = () => {
  return (
    <div className="text-white flex flex-col items-start justify-center gap-2 w-full md:max-w-2xl lg:max-w-5xl mx-auto px-6 md:px-0">
        ...
        <h2 className="text-base text-left text-white/80">Full Stack Developer | Blockchain Enthusiast | Recent Build: <Link href="https://trueman.ashutoshsagar.com/" target="_blank" className="text-[#1dd79b]">Trueman CEX in Rust</Link></h2>
