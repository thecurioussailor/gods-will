...
const words = "I build production Solana apps across mobile and web with smooth Web3 UX, payments, and backend systems. Recently shipped a fantasy sports app with USDC payments to the Solana dApp Store & Android web.";
const Hero = () => {
  return (
    <div className="text-white flex flex-col items-start justify-center gap-2 w-full md:max-w-2xl lg:max-w-5xl mx-auto px-6 md:px-0">
        ...
        <h2 className="text-base text-left text-white/80 flex flex-wrap gap-2">Solana Mobile & Full-Stack Engineer | Recent Builds:  
